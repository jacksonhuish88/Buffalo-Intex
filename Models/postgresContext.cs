...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseNpgsql("Host=demo-postgres.ct3qfazoywwe.us-east-1.rds.amazonaws.com;Database=postgres;Port=5432;Username=postgres;Password=adminadmin");
            }
        }
        ...
        public DbSet<Buffalo_Intex.AspNetUsers> AspNetUsers { get; set; }
    }
}
